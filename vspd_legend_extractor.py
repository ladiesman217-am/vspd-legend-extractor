# ============================================================
#  VSPD Legend Plant Extractor
#  ------------------------------------------------------------
#  A Streamlit app for extracting and normalizing plant legends
#  from PDF or image files (JPG, PNG). Outputs a clean, sorted
#  Excel plant schedule, branded for VSPD.
#
#  Author: Valley Slope Protection Design (VSPD)
#  Version: 1.0
#  ------------------------------------------------------------
#  Setup:
#     pip install streamlit pandas pytesseract pillow pdf2image openpyxl
#
#  Deploy:
#     - Place this file and vspd_logo.png in your GitHub repo.
#     - Deploy via Streamlit Cloud: https://streamlit.io/cloud
#     - App file: vspd_legend_extractor.py
#
# ============================================================
...
CATEGORY_LOOKUP = {
    "Tree": [
        "quercus", "prosopis", "acacia", "parkisonia", "cercidium",
...
def parse_plant_text(raw_text):
    ...
    df = pd.DataFrame(data, columns=[\"Category\", \"Quantity\", \"Botanical / Common Name\", \"Size\", \"Height × Width\"])
...
if uploaded_files and project_name:
    ...
    header_df = pd.DataFrame({\"Category\": [f\"Project: {project_name} — Generated by VSPD Legend Plant Extractor (VSPD)\"]})
